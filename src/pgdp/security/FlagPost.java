    ...
    public String toString() {
        if (getLevel() == 0) {
            return "Signal post " + getPostNumber() +
                    " of type  flag post  is in level " + getLevel() + " and is  doing nothing";
        }
        else {
            return "Signal post " + getPostNumber() + " of type  flag post  is in level " +
                    getLevel() + " and is  waving  " + getDepiction();
        }
    }
